...
if __name__ == "__main__":
    ...
    #YW: add these lines to make sure non-exist folders are created before output into it
    ...
    if sys.argv[1] == "train":
        ...
        #YW: add two lines before all_Data.write to make sure non-exist folder are created before output into it
        filename = f"../data/reconstructed/CGAN/cgan_cd4t.h5ad"
