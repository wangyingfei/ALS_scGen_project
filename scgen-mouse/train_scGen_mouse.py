...
def test_train_whole_data_one_celltype_out(data_name="mouse",
                                           z_dim=50,
                                           alpha=0.1,
                                           n_epochs=1000,
                                           batch_size=32,
    ...
    if data_name == "mouse":
        ...
        train = sc.read("../data/train_m.h5ad")
        valid = sc.read("../data/valid_m.h5ad")
...
#YW: added cell_type_to_reconstruct=None as def function default option - (enable constructing only human diseased dataset)
def reconstruct_whole_data(data_name="mouse", condition_key="status", cell_type_to_reconstruct=None):
    if data_name == "mouse":
        stim_key = "sod1"
        ctrl_key = "wt"
        cell_type_key = "timepoint"
...
if __name__ == '__main__':
    #test_train_whole_data_one_celltype_out("mouse", z_dim=100, alpha=0.00005, n_epochs=300, batch_size=32,
    ...
    ##                                       dropout_rate=0.2, learning_rate=0.001)
    test_train_whole_data_one_celltype_out("species", z_dim=100, alpha=0.00005, n_epochs=3, batch_size=32,
                                           dropout_rate=0.2, learning_rate=0.001, cell_type_to_train="human")
    #train_cross_study("study", z_dim=100, alpha=0.00005, n_epochs=300, batch_size=32,
    #                  dropout_rate=0.2, learning_rate=0.001)
    #reconstruct_whole_data("mouse")
    ...
    reconstruct_whole_data("species", cell_type_to_reconstruct="human")
